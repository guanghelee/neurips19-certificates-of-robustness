...
parser.add_argument('--r_start', default=5, type=int, 
                    help='[r_start, r_end)')
parser.add_argument('--r_end', default=6, type=int, 
                    help='[r_start, r_end)')
parser.add_argument('--fn', default='imagenet', type=str, 
                    help='dataset to run')
parser.add_argument('--a', type=int, default=1,
                    help='alpha = a / 10')
parser.add_argument('--p', type=int, default=-1,
                    help='partition used in this radius')
...
if fn == 'mnist':
	...
	fp.write('v\tp_given\terr\n')

for v in range(v_range[0], v_range[1]):
	if fn != 'mnist':
		fp = open('thresholds/{}/{}_{}.txt'.format(fn, frac_alpha, v), 'w')
		fp.write('v\tp_given\terr\n')
