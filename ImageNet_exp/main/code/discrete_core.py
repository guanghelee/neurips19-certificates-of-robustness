...
class Smooth(object):
    ...
    def __init__(self, base_classifier: torch.nn.Module, num_classes: int, calibrated_alpha: float, K: int):
        """
    ...
    def _sample_noise(self, x: torch.tensor, num: int, batch_size) -> np.ndarray:
        ...
        with torch.no_grad():
            ...
            for _ in range(ceil(num / batch_size)):
                ...
                rand_inputs = torch.randint_like(batch, low=0, high=self.K+1, device='cuda') / float(self.K)
